...
// Import qrcode Scanner
import QRCodeScanner from 'react-native-qrcode-scanner'

// สร้างตัวแปรเก็บความกว้างและความสูง
...
const Scan = () => {
  ...
  // ฟังก์ชันสำหรับเรียกแสดง QRCode
  activeQR = () => {
    setScan(true)
  }

  // ฟังก์ชันสำหรับเรียก Scan ซ้ำอีกครั้งหนึ่ง
  scanAgain = () => {
    setScan(true)
    setscanResult(false)
  }
        ...
        {scanResult &&
            <Fragment>
                ...
                <View style={scanResult ? styles.scanCardView : styles.cardView}>
                    ...
                    <Text numberOfLines={8}>RawData: {result.rawData}</Text>
